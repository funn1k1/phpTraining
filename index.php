...
$links=$data['links'];
$colMd10=$data['colMd10'];
$colSm6=$data['colSm6'];
$slickTexts=$data['slickSlides']['texts'];
$slickNames=$data['slickSlides']['slickNames'];
$contFluidsImages=$data['containerFluids']['images'];
$blocksFluid=$data['containerFluid']['blocks'];
$colsXs6=$data['colXs6'];
$rowsXl70=$data['rowsXl70'];
$rows30=$data['rows30'];
$container=$data['container'];
$colsLg4=$data['colsLg4'];
$colLg8=$data['colLg8'];
$colLg6=$data['colLg6'];
$colsMd3=$data['colsMd3'];
$colsMd4=$data['colsMd4'];
$colMd5=$data['colMd5'];
$colSm11=$data['colSm11'];
$colLg5=$data['colLg5'];
$colMd11=$data['colMd11'];
$listNumbers=$data['colMd11']['numbers'];
$listDays=$data['colMd11']['listDays'];
$listEmails=$data['colMd11']['listEmails'];
$footerIcons=$data['footer']['icons'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="page"><a class="section section-banner d-none d-xl-flex" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="background-image: url(images/banners/background-04-1920x60.jpg); background-image: -webkit-image-set( url(images/banners/background-04-1920x60.jpg) 1x, url(images/banners/background-04-3840x120.jpg) 2x )" target="_blank"><img src="images/banners/foreground-04-1600x60.png" srcset="images/banners/foreground-04-1600x60.png 1x, images/banners/foreground-04-3200x120.png 2x" alt="" width="1600" height="310"></a>
          ...
          <div class="navbar-container">
            <div class="navbar-cell">
              <div class="navbar-panel">
                ...
                <div class="navbar-logo"><a class="navbar-logo-link" href="index.php"><img class="navbar-logo-default" src="images/logo-default-161x27.svg" alt="Intense" width="161" height="27"/><img class="navbar-logo-inverse" src="images/logo-inverse-161x27.svg" alt="Intense" width="161" height="27"/></a></div>
              </div>
            </div>
            ...
            <div class="navbar-cell navbar-sidebar">
              <ul class="navbar-navigation rd-navbar-nav">
                ...
                <li class="navbar-navigation-root-item"><a class="navbar-navigation-root-link" href="about-us.html"><?=$link?></a>
                </li>
                <?}?>
              </ul>
            </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6" data-animate='{"class":"fadeInUp"}'>
              <h1><?=$colMd10['title']?></h1>
              <p><?=$colMd10['text']?></p>
              <div class="offset-md group-30"><a class="btn btn-lg btn-primary" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" target="_blank"><?=$colMd10['buttons']['textBtn1']?></a><a class="btn btn-lg btn-secondary" href="#journey" data-anchor-link=""><?=$colMd10['buttons']['textBtn2']?></a></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row row-30 align-items-center justify-content-lg-between">
            <div class="col-sm-6 col-md-5 col-lg-4" data-animate='{"class":"fadeInLeft"}'>
              <h6 class="text-primary"><?=$colSm6['title1']?></h6>
              <h1><?=$colSm6['title2']?></h1>
              <p><?=$colSm6['text']?></p>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center slick-creative">
            ...
            <div class="col-md-5 pt-5" style="padding-bottom: 14.2%">
              <div class="pl-xxl-3">
                <h6 class="text-primary"><?=$data['slickSlides']['h6']?></h6>
                <div class="slick-slider slider-nav" data-slick='{"arrows":false,"asNavFor":".slider-for","autoplay":true,"autoplaySpeed":3000,"focusOnSelect":true,"variableWidth":true}'>
                  <?foreach($slickNames as $slickName){?>
                  <div class="slick-dot"><?=$slickName?></div>
                  <?}?>
                </div>
                <div class="slick-slider slider-for" data-slick='{"arrows":false,"asNavFor":".slider-nav"}'>
                  <?foreach($slickTexts as $slickText){?>
                  <p><?=$slickText?></p>
                  <?}?>
                </div>
              </div>
      ...
      <section class="section section-lg bg-gradient-animated">
        <div class="container-fluid">
          ...
          <?foreach($blocksFluid as $blockFluid){?>
            <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                    <!-- Layout-->
                    <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="index.php"><img src="<?=$blockFluid['img']?>" alt="" width="336" height="450"/></a>
                      <div class="layout-title h6"><a class="layout-title-link" href="index.php"><?=$blockFluid['text']?></a>
                      </div>
                    </article>
              ...
              <div class="row row-50 row-lg-80 row-xl-100 row-xxl-150">
                <div class="col-12" id="Design">
                  ...
                  <div class="row row-offset-lg row-30 row-md-50 row-xl-70 justify-content-xl-between">
                    <?foreach($colsXs6 as $colXs6){?>
                    <div class="col-xs-6 col-md-6 col-xxl-5" data-animate='{"class":"fadeInUp"}'>
                            <article class="blurb">
                              <div class="blurb-embed"><span class="<?=$colXs6['img']?>"></span></div>
                              <div class="blurb-title h5"><?=$colXs6['title']?></div>
                              <div class="blurb-text"><?=$colXs6['text']?></div>
                            </article>
                    </div>
                   <?}?>
                  </div>
                ...
                <div class="col-12" id="Development">
                  ...
                  <div class="row row-offset-lg row-30 row-md-50 row-xl-70 justify-content-xl-between">
                  <?foreach($rowsXl70 as $rowXl70){?>
                    <div class="col-xs-6 col-md-6 col-xxl-5" data-animate='{"class":"fadeInUp"}'>
                            <!-- Blurb-->
                            <article class="blurb blurb-boxed blurb-dark">
                              <div class="blurb-embed"><span class="<?=$rowXl70['img']?>"></span></div>
                              <div class="blurb-title h5"><?=$rowXl70['title']?></div>
                              <div class="blurb-text"><?=$rowXl70['text']?></div>
                            </article>
                    </div>
                    <?}?>
                </div>
                <div class="col-12" id="Customization">
                  ...
                  <div class="row row-offset-lg row-30 row-md-50 row-xl-70 justify-content-xl-between">
                  <?foreach($rows30 as $row30){?>
                    <div class="col-xs-6 col-md-6 col-xxl-5 align-self-center" data-animate='{"class":"fadeInUp"}'>
                            <!-- Blurb-->
                            <article class="blurb">
                              <div class="blurb-embed"><span class="<?=$row30['img']?>"></span></div>
                              <div class="blurb-title h5"><?=$row30['title']?></div>
                              <div class="blurb-text"><?=$row30['text']?></div>
                            </article>
                    </div>
                    <?}?>
                  </div>
      ...
      <section class="section section-lg bg-transparent">
        <div class="container">
          <div class="text-center" data-animate='{"class":"fadeInUp"}'>
            ...
            <p><?=$container['text']?></p><a class="btn btn-lg btn-dark" href="#"><?=$container['btnText']?></a>
          </div>
        </div>
      </section>
      <!-- Quote default-->
                        ...
                        <q><?=$colLg4['text']?></q>
                            ...
                            <div class="quote-author">
                              <div class="media media-md align-items-center">
                                <div class="media-left"><img class="quote-author-image" src="<?=$colLg4['img']?>" alt="" width="64" height="64"/>
                                </div>
                                <div class="media-body">
                                  <div class="quote-author-name"><?=$colLg4['name']?></div>
      ...
      <section class="section section-lg bg-primary-light text-center text-lg-left">
        <div class="container">
          <div class="row row-30 align-items-lg-center justify-content-lg-between">
            ...
            <div class="col-lg-auto" data-animate='{"class":"fadeInRight"}'><a class="btn btn-lg btn-secondary" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" target="_blank"><?=$colLg8['btnTxt']?></a></div>
          </div>
        </div>
      </section>
      <!-- Features-->
              ...
              <div class="tab">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="navClassic2-1" role="tabpanel">
                    <div class="row row-30">
                    <?foreach($colsMd3 as $colMd3){?>
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="<?=$colMd3['img']?>"></span></div>
                                <div class="blurb-title h6"><?=$colMd3['text']?></div>
                              </article>
                      </div>
                      <?}?>
                    </div>
                  ...
                  <div class="tab-pane fade" id="navClassic2-2" role="tabpanel">
                    <div class="row row-30">
                    <?foreach($colsMd4 as $coldMd4){?>
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4">
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="<?=$coldMd4['img']?>"></span></div>
                                <div class="blurb-title h6"><?=$coldMd4['text']?></div>
                              </article>
                      </div>
                      <?}?>
                    </div>
      ...
      <footer class="section footer bg-800 text-400 context-dark">
        <div class="container">
            ...
            <div class="col-sm-11 col-md-9 col-lg-7 col-xl-6 text-center">
              ...
              <form class="rd-mailform form-inline justify-content-center group-20" data-form-output="footer-extended-form-output" data-form-type="subscribe" method="post" action="components/rd-mailform/rd-mailform.php">
                <div class="form-inline-group">
                  <input class="form-control" type="email" name="email" placeholder="<?=$colSm11['inpTxt']?>" data-constraints="@Email @Required">
                </div>
          ...
          <div class="row row-30 justify-content-xxl-between">
            <div class="col-lg-5">
                    <!-- Logo-->
                    <div class="logo"><a class="logo-link" href="index.php"><img class="logo-image-default" src="<?=$colLg5['img1']?>" alt="Intense" width="161" height="27"/><img class="logo-image-inverse" src="<?=$colLg5['img2']?>" alt="Intense" width="161" height="27"/></a></div>
              <p class="small"><?=$colLg5['text']?></p>
            </div>
            <div class="col-md-11 col-lg-7 col-xxl-6">
              <p class="small"><?=$colMd11['text']?></p>
              <div class="row row-20">
                  ...
                  <div class="media media-xxs text-white">
                    ...
                    <div class="media-body">
                      ...
                      <?foreach($listNumbers as $number ){?>
                        <li class="list-contact-item"><a class="list-contact-link" href="tel:#"><?=$number?></a></li>
                        <?}?>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col-auto col-sm-4">
                  ...
                  <?foreach($listEmails as $email){?>
                    <li class="list-item"><a class="link link-contrast link-secondary" href="mailto:#"><?=$email?>></a></li>
                  <?}?>
                  </ul>
                </div>
              </div>
